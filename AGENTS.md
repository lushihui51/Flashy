...
- Every deletion of a subject, deck, field, or card goes through `compute_deletion_impact` then `apply_deletion` in `app/services/deletion.py`, inside the deleting transaction (ADR 051)
