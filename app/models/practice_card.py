...
class PracticeCardBase(AppModel):
    ...
    prompt_fields: dict[str, Any] = Field(sa_column=Column(JSONB, nullable=False))
    answer_fields: dict[str, Any] = Field(sa_column=Column(JSONB, nullable=False))
    prompt_pool: dict[str, Any] = Field(sa_column=Column(JSONB, nullable=False))
    answer_pool: dict[str, Any] = Field(sa_column=Column(JSONB, nullable=False))
