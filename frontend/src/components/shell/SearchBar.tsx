  ...
  return (
    <div className="relative flex w-full items-center">
      ...
      <input
        ...
        className="h-11 w-full rounded-full bg-[var(--color-surface-elevated)] pl-10 pr-4 text-[var(--color-text)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
      />
    </div>
  );
}
